...
namespace GLBase{
	...
	const Renderer& Application::renderer() const { return _renderer; } 
	Application::duration Application::runtime() const { return _runtime; }
	void Application::resetRuntime() { _runtime = duration{0}; }
